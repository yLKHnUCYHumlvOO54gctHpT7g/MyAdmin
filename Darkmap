...
local config = {
    ...
    baseHeight = 3,
    positions = {
        -- Increased height for all body parts
        leftUpperLeg = CFrame.new(-10000000, 50, 25000000),    
        rightUpperLeg = CFrame.new(10000000, 50, 25000000),    
        leftLowerLeg = CFrame.new(-10000000, 50, -25000000),   
        rightLowerLeg = CFrame.new(10000000, 50, -25000000),   
        upperTorso = CFrame.new(101, 50, -2150002),
        lowerTorso = CFrame.new(101, 50, -2150002),
        head = CFrame.new(101, 50, -2152),
        leftArm = CFrame.new(-7500, 50, -7500),
        rightArm = CFrame.new(7500, 50, 7500)
    },
    lastPosition = nil,
    shouldAnchor = false,
    disablePosition = nil
...
DragLabel.Text = "Dark Map made by AK"
...
local function toggleBlocking()
    ...
    if config.blockingEnabled then
        ...
        -- First unbind the update function
