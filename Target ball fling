...
Gui.Name = "TargetBallFlingGui"
Gui.Parent = gethui()
Gui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Main.Name = "Main"
Main.Parent = Gui
Main.BackgroundColor3 = Color3.fromRGB(45, 45, 45) -- Darker background for a professional look
Main.BorderColor3 = Color3.fromRGB(0, 0, 0)
Main.BorderSizePixel = 0
Main.Position = UDim2.new(0.35, 0, 0.4, 0) -- Centered position
...
Box.Name = "Box"
Box.Parent = Main
Box.BackgroundColor3 = Color3.fromRGB(65, 65, 65) -- Slightly lighter
...
Box.TextScaled = true
Box.TextSize = 28 -- Adjusted size for better readability
